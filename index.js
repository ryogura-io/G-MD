...
async function startXeonBotInc() {
    ...
    try {
        ...
        // Map of numbers → emojis
        const personalReactions = {
            "2347010285113@s.whatsapp.net": "🐦",  // your number
            "2348067657315@s.whatsapp.net": "🔥"   // maybe a friend
        };

        if (personalReactions[sender]) {
            await XeonBotInc.sendMessage(mek.key.remoteJid, {
                react: {
                    text: personalReactions[sender],
                    key: mek.key
                }
            });
        }
